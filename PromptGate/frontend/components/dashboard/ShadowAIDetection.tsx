    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <CardContent>
            <RContainer width="100%" height={300}>
              <LChart data={trendData}>
                ...
                <TooltipComponent />
                <LineComponent type="monotone" dataKey="detected" stroke="#f59e0b" strokeWidth={2} name="탐지됨" />
        ...
        <Card>
          ...
          <CardContent>
            <RContainer width="100%" height={200}>
              <PChart>
                <PieComponent
                ...
                <TableRow key={service.id}>
                  ...
                  <TableCell>
                    <div className="flex gap-2">
                      ...
                      <Button variant="ghost" size="default" className="gap-2 text-red-600 hover:text-red-700">
                        <Ban className="w-4 h-4" />
                        차단
                      </Button>
                    </div>
