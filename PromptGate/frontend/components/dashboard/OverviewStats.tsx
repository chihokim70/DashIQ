  ...
  return (
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <RContainer width="100%" height={300}>
              <LChart data={usageData}>
                <CartesianGridComponent strokeDasharray="3 3" stroke="#e2e8f0" />
                <XAxisComponent dataKey="date" stroke="#64748b" />
                <YAxisComponent stroke="#64748b" />
                <TooltipComponent />
                <LineComponent type="monotone" dataKey="requests" stroke="#3b82f6" strokeWidth={2} name="전체 요청" />
                <LineComponent type="monotone" dataKey="blocked" stroke="#ef4444" strokeWidth={2} name="차단됨" />
              </LChart>
            </RContainer>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              <RContainer width="50%" height={250}>
                <PChart>
                  <PieComponent
                    data={aiServiceData}
                    cx="50%"
      ...
      <Card>
        ...
        <CardContent>
          <RContainer width="100%" height={300}>
            <BChart data={threatData}>
              <CartesianGridComponent strokeDasharray="3 3" stroke="#e2e8f0" />
              <XAxisComponent dataKey="category" stroke="#64748b" />
              <YAxisComponent stroke="#64748b" />
              <TooltipComponent />
              <BarComponent dataKey="count" fill="#ef4444" name="탐지 건수" />
            </BChart>
          </RContainer>
        </CardContent>
      </Card>
